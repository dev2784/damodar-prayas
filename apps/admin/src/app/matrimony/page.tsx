...
export default function MatrimonyModerationPage(){
  ...
  const load=useCallback(async()=>{
    ...
    }catch(e){if(e instanceof Error&&e.message==='SESSION_EXPIRED'){clearAdminSession();router.replace('/login');return;} setError(e instanceof Error?e.message:'Data load failed');}
