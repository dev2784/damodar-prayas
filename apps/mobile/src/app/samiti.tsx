  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.content}>
        <Text style={styles.eyebrow}>SAMITI</Text>
        <Text style={styles.title}>समिति</Text>
        <Text style={styles.text}>समाज की समितियाँ, पदाधिकारी और संपर्क जानकारी यहाँ दिखाई देगी।</Text>
      </View>
    </SafeAreaView>
  );
}
